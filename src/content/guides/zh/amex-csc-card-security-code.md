...
AMEX CSC 计算与标准 [CVV 计算](/zh/guides/cvv-cvc-calculation-methods/) 有一些相似之处，但使用不同的密钥管理和处理步骤。
...
2. 使用 CSC 密钥 A 进行 [3DES](/zh/guides/des-3des-legacy-encryption/) 加密
3. 与剩余 PAN 数据进行 XOR
4. 再次加密
...
- 在 [HSM](/zh/guides/hsm-key-management-overview/) 内部生成
- 以 [LMK](/zh/guides/thales-lmk-key-encryption/) 加密形式存储
