...
const toolConfigs: ToolConfig[] = [
  ...
  { icon: <AppstoreOutlined />, titleKey: 'bitmap', descKey: 'bitmap', path: '/payments-bitmap', color: 'linear-gradient(135deg, #96fbc4 0%, #f9f586 100%)', category: 'payment', keywords: ['iso 8583', 'bitmap', 'payment message', 'field indicator', 'primary', 'secondary', 'financial', 'transaction'] },
