...
export default {
  ...
  as2805: {
    ...
    outPinBlock: 'Outgoing PIN Block',
    ...
    resultKekr: 'KEKr',
    resultSchemeKek: 'Key Scheme KEK',
    resultSchemeLmk: 'Key Scheme LMK',
    resultKcvType: 'Key Check Value Type',
    resultZpkUnderLmk: 'ZPK under LMK',
    resultZpkUnderKek: 'ZPK under KEK',
    resultKcvZpk: 'KCV of ZPK',
    resultTpkUnderLmk: 'TPK under LMK',
    resultTpkUnderKek: 'TPK under KEK',
    resultKcvTpk: 'KCV of TPK',
    resultTaksUnderLmk: 'TAKs under LMK',
    resultTakrUnderLmk: 'TAKr under LMK',
    resultTaksUnderKek: 'TAKs under KEK',
    resultTakrUnderKek: 'TAKr under KEK',
    resultKcvTaks: 'KCV of TAKs',
    resultKcvTakr: 'KCV of TAKr',
    resultTeksUnderLmk: 'TEKs under LMK',
    resultTekrUnderLmk: 'TEKr under LMK',
    resultTeksUnderKek: 'TEKs under KEK',
    resultTekrUnderKek: 'TEKr under KEK',
    resultKcvTeks: 'KCV of TEKs',
    resultKcvTekr: 'KCV of TEKr',
  },
