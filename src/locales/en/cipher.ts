...
export default {
  cipher: {
    ...
    // Symmetric cipher form errors
    errorKeyHexRequired: 'Key must be valid hexadecimal',
    errorKeyLengthSingle: 'Key length must be {length} bytes',
    errorKeyLengthMultiple: 'Key length must be {lengths} bytes',
    errorDataHexRequired: 'Data must be valid hexadecimal',
    errorDataBlockSize: 'Data length must be multiple of {blockSize} bytes (current: {current} bytes)',
    errorIvHexRequired: 'IV must be valid hexadecimal',
    errorIvBlockSize: 'IV length must be {blockSize} bytes',
  },
  ...
  rsa: {
    ...
    signingFinished: 'Data signing operation finished',
    ...
    privateKeyLabel: 'Private Exp. (d):',
    keyLengthLabel: 'Key length:',
    encryptionMethodLabel: 'Encryption method:',
    decryptionMethodLabel: 'Decryption method:',
    paddingMethodLabel: 'Padding Method:',
    originalDataLabel: 'Original data:',
    cipherDataLabel: 'Cipher data:',
    publicModulusLabel: 'Public modulus [n]:',
    publicExponentLabel: 'Public exponent [e]:',
    privateExponentLabel: 'Private exponent [d]:',
    encodedDataLabel: 'Encoded data:',
    encodedDataLengthLabel: 'Encoded data length:',
    decodedDataLabel: 'Decoded data:',
    decodedDataLengthLabel: 'Decoded data length:',
    stringToSignLabel: 'String to sign:',
    stringToSignLengthLabel: 'String to sign length:',
    messageDigestTypeLabel: 'Message digest type:',
    messageDigestLengthLabel: 'Message digest length:',
    stringToHashLabel: 'String to {hash} hash:',
    messageSignatureLabel: 'Message Signature:',
    messageSignatureLengthLabel: 'Msg. Signature length:',
    // Verify tab
    inputTypeLabel: 'Input type:',
    inputDataWillBeHashed: 'Data (will be hashed)',
    inputHashDirectComparison: 'Hash (direct comparison)',
    hashToVerify: 'Hash to Verify',
    hashPlaceholder: 'Enter hash value in hexadecimal (e.g. SHA-1: 40 hex chars)',
    hashAlgorithmHint: 'Select the algorithm used when signing to extract correct hash length',
    // OAEP tab
    encodingParametersLabel: 'Encoding Parameters:',
    optionalLabelPlaceholder: 'Optional label (empty by default)',
    methodLabel: 'Method:',
    resultLengthLabel: 'Result Length:',
    hashFunctionLabel: 'Hash Function:',
    encodedMessageLabel: '✓ Encoded Message (EM):',
    decodedMessageLabel: '✓ Decoded Message:',
    resultLengthBytes: 'Length: {bytes} bytes ({bits} bits)',
    oaepStructureReference: '📖 OAEP Structure & Reference',
    structureLabel: 'Structure:',
    maxDataSizeLabel: 'Max Data Size (k = key bytes):',
    oaepMaxSizeSHA1: 'SHA-1: k - 42 bytes',
    oaepMaxSizeSHA224: 'SHA-224: k - 58 bytes',
    oaepMaxSizeSHA256: 'SHA-256: k - 66 bytes',
    oaepMaxSizeSHA384: 'SHA-384: k - 98 bytes',
    oaepMaxSizeSHA512: 'SHA-512: k - 130 bytes',
    oaepEncodePlaceholder: 'Enter data to encode (hexadecimal)',
    oaepDecodePlaceholder: 'Enter OAEP encoded data (hexadecimal)',
    encode: 'Encode',
    decode: 'Decode',
    bits: 'bits',
  },
