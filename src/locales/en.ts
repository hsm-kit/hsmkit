...
export default {
  ...
  home: {
    ...
    tools: {
      ...
      as2805: {
        ...
        description: 'Parse, analyze and operate on AS2805 payment messages (Australian ISO 8583 variant). Includes Terminal Key Set generation, PIN Block translation, ISO9797-1 TDES-CBC MAC calculation, OWF (HMAC-SHA256), and key/KCV utilities. Client-side only — your data never leaves your device.',
      },
      bitmap: {
  ...
  dukpt: {
    ...
    errorInvalidIpek: 'IPEK must be 32 hex characters',
    errorInvalidKsn: 'KSN must be 20 hex characters',
    errorInvalidPekPin: 'PEK must be 32 hex characters',
    errorInvalidPinBlock: 'PIN block must be 16 hex characters',
    errorInvalidPekMac: 'PEK must be 32 or 48 hex characters',
