...
export default {
  ...
  as2805: {
    ...
    info1: 'Includes terminal key set, PIN block translation, MAC and OWF',
  ...
  dukptAes: {
    ...
    mac: 'MAC',
    errorInvalidBdk: 'BDK must be correct hex length',
    errorInvalidIk: 'IK must be correct hex length',
    errorInvalidKsn: 'KSN must be 24 hex characters',
    errorInvalidPek: 'PEK must be correct hex length',
    errorInvalidPinBlock: 'PIN block must be 32 hex characters',
    errorInvalidMacGen: 'MAC Gen. must be correct hex length',
    errorInvalidDek: 'DEK must be correct hex length',
    errorInvalidData: 'Data is required',
    errorInvalidEncryptedData: 'Encrypted data must be multiple of block size',
  ...
  mac: {
    ...
    ansimac: {
      ...
      description: 'Calculate MAC using ANSI X9.9 (Wholesale) or X9.19 (Retail) algorithms.',
      algorithm: 'Algorithm',
      keyK: 'Key (K)',
      keyKPrime: 'Key (K\')',
      data: 'Data (Hex)',
    ...
    as2805: {
      title: 'AS2805 MAC',
      description: 'Calculate MAC using AS2805.4.1 Method 1 or Method 2.',
      algorithm: 'Algorithm',
      keyKL: 'Key (K|KL)',
      keyKR: 'Key (KR)',
      data: 'Data (Hex)',
  ...
  seo: {
    ...
    pinBlockGeneral: {
      ...
      description: 'Free online PIN Block encoder and decoder supporting all ISO 9564 formats (0, 1, 2, 3, 4). Encode PINs into PIN blocks or decode PIN blocks back to PIN. Essential tool for payment security, HSM testing, and card transaction development.',
      keywords: 'PIN block encoder, PIN block decoder, ISO 9564, PIN block format 0, PIN block format 1, PIN block format 2, PIN block format 3, PIN block format 4, PIN encryption, payment security, HSM testing, card PIN, PAN, PIN decoder',
      faqTitle: 'PIN Block Encoder/Decoder FAQ',
      usageTitle: 'How to Use PIN Block Tool',
      faqs: [
        { question: 'What are the differences between PIN Block formats?', answer: 'Format 0: XORs PIN with PAN (most common). Format 1: Random padding, no PAN needed. Format 2: Similar to 0 with different control field. Format 3: Random padding with PAN. Format 4: Designed for AES, 128-bit block size.' },
        { question: 'When should I use Format 0 vs Format 1?', answer: 'Format 0 is the most widely used in card payments because it binds the PIN to a specific card (PAN). Format 1 is used when PAN is not available or for general-purpose PIN transmission where card binding is not required.' },
        { question: 'What is the padding character used for?', answer: 'The padding character (typically "F") fills unused positions in the PIN block after the PIN digits. This creates a fixed-length block suitable for encryption. Different systems may use different padding characters.' },
        { question: 'Can I decode a PIN block without the PAN?', answer: 'Only Format 1 can be decoded without a PAN, as it uses random padding instead of XOR with PAN data. Formats 0, 2, 3, and 4 require the PAN to reverse the XOR operation and recover the original PIN.' },
        { question: 'What is Format 4 used for?', answer: 'Format 4 is the newest format (ISO 9564-1:2017) designed specifically for AES encryption. It uses a 128-bit block size (32 hex characters) and includes random padding for enhanced security. It\'s gradually being adopted in modern payment systems.' },
      ],
      usage: [
        'Select the PIN Block format (0, 1, 2, 3, or 4) you want to use.',
        'Choose "Encode" to convert a PIN to a PIN block, or "Decode" to extract a PIN from a PIN block.',
        'For encoding: Enter the PIN (4-12 digits), PAN (card number), and optionally change the padding character.',
        'For decoding: Enter the PIN block (hex) and PAN (if required by the format).',
        'Click the Encode or Decode button to process.',
        'The result displays the PIN block (for encoding) or the decoded PIN (for decoding).',
      ],
    },
    pinBlockAes: {
    ...
    iso9797Mac: {
      title: 'ISO/IEC 9797-1 MAC Calculator Online - Message Authentication Code | HSM Kit',
      description: 'Free online ISO/IEC 9797-1 MAC calculator. Supports 6 MAC algorithms with various padding methods. Calculate message authentication codes for payment and security systems.',
      keywords: 'ISO 9797 MAC, MAC calculator, message authentication code, ISO9797-1, DES MAC, 3DES MAC, payment MAC, retail MAC',
      faqTitle: 'ISO 9797-1 MAC FAQ',
      usageTitle: 'How to Use ISO 9797-1 MAC Calculator',
      faqs: [
        { question: 'What is ISO/IEC 9797-1?', answer: 'ISO/IEC 9797-1 is an international standard that defines multiple MAC (Message Authentication Code) algorithms for data integrity and authentication using block ciphers like DES and 3DES.' },
        { question: 'Which MAC algorithm should I use?', answer: 'Algorithm 1 is the simplest (DES CBC-MAC). Algorithm 3 (Retail MAC) is more secure with final 3DES encryption. Choose based on your security requirements and system compatibility.' },
        { question: 'What are the padding methods?', answer: 'Method 1 pads with zeros, Method 2 uses 0x80 followed by zeros (more secure), and Method 3 includes the data length. Method 2 is recommended for better security.' },
      ],
      usage: [
        'Select the MAC algorithm (Algorithm 1-6) from the dropdown.',
        'Enter the required keys in hexadecimal format.',
        'Choose padding method and enter the data to be authenticated.',
        'Set truncation length (1-8 bytes) and click "Calculate MAC".',
      ],
    },
    ansiMac: {
      title: 'ANSI MAC Calculator Online - X9.9 & X9.19 MAC Generator | HSM Kit',
      description: 'Free online ANSI MAC calculator for X9.9 (Wholesale) and X9.19 (Retail) algorithms. Generate message authentication codes for financial transactions.',
      keywords: 'ANSI MAC, X9.9 MAC, X9.19 MAC, wholesale MAC, retail MAC, financial MAC, payment MAC, DES MAC',
      faqTitle: 'ANSI MAC FAQ',
      usageTitle: 'How to Use ANSI MAC Calculator',
      faqs: [
        { question: 'What is ANSI X9.9?', answer: 'ANSI X9.9 is the Wholesale MAC algorithm using DES CBC mode. It is widely used in financial messaging for message authentication.' },
        { question: 'What is ANSI X9.19?', answer: 'ANSI X9.19 is the Retail MAC algorithm that uses DES CBC with a final 3DES encryption of the last block for enhanced security.' },
        { question: 'When should I use X9.19 instead of X9.9?', answer: 'Use X9.19 when stronger security is required, especially for retail banking transactions. The final 3DES encryption makes it more resistant to attacks.' },
      ],
      usage: [
        'Select algorithm (X9.9 or X9.19).',
        'Enter Key K and Key K\' (16 hex characters each).',
        'Enter data in hexadecimal format.',
        'Set truncation and click "Calculate MAC".',
      ],
    },
    as2805Mac: {
      title: 'AS2805 MAC Calculator Online - Australian Payment MAC | HSM Kit',
      description: 'Free online AS2805.4.1 MAC calculator. Generate MAC for Australian payment systems using Method 1 or Method 2.',
      keywords: 'AS2805 MAC, Australian payment, EFTPOS MAC, AS2805.4.1, payment MAC, financial MAC',
      faqTitle: 'AS2805 MAC FAQ',
      usageTitle: 'How to Use AS2805 MAC Calculator',
      faqs: [
        { question: 'What is AS2805?', answer: 'AS2805 is an Australian Standard for EFTPOS messaging. AS2805.4.1 defines MAC algorithms for message authentication in Australian payment systems.' },
        { question: 'What is the difference between Method 1 and Method 2?', answer: 'Method 2 uses 3DES for the final block encryption, providing stronger security than Method 1 which uses DES only.' },
      ],
      usage: [
        'Select algorithm (Method 1 or Method 2).',
        'Enter Key K|KL and Key KR (16 hex characters each).',
        'Enter data and click "Calculate MAC".',
      ],
    },
    tdesCbcMac: {
      title: 'TDES CBC-MAC Calculator Online - Triple DES Message Authentication | HSM Kit',
      description: 'Free online TDES CBC-MAC calculator. Generate message authentication codes using Triple DES in CBC mode.',
      keywords: 'TDES CBC-MAC, Triple DES MAC, 3DES MAC, CBC-MAC, message authentication, DES MAC',
      faqTitle: 'TDES CBC-MAC FAQ',
      usageTitle: 'How to Use TDES CBC-MAC Calculator',
      faqs: [
        { question: 'What is TDES CBC-MAC?', answer: 'TDES CBC-MAC is a message authentication code algorithm that uses Triple DES encryption in CBC (Cipher Block Chaining) mode to generate authentication tags.' },
        { question: 'What key length should I use?', answer: 'Use 48 hex characters (24 bytes) for 3-key Triple DES, or 32 hex characters (16 bytes) for 2-key Triple DES. 3-key provides stronger security.' },
      ],
      usage: [
        'Enter TDES key (32 or 48 hex characters).',
        'Select padding method.',
        'Enter data and truncation length.',
        'Click "Calculate MAC".',
      ],
    },
    hmac: {
      title: 'HMAC Calculator Online - Hash-based Message Authentication | HSM Kit',
      description: 'Free online HMAC calculator supporting SHA-1, SHA-256, SHA-512, MD5 and more. Generate hash-based message authentication codes.',
      keywords: 'HMAC calculator, HMAC-SHA256, HMAC-SHA512, HMAC-MD5, hash-based MAC, message authentication',
      faqTitle: 'HMAC FAQ',
      usageTitle: 'How to Use HMAC Calculator',
      faqs: [
        { question: 'What is HMAC?', answer: 'HMAC (Hash-based Message Authentication Code) combines a cryptographic hash function with a secret key to create message authentication codes. It provides both data integrity and authenticity.' },
        { question: 'Which hash function should I use?', answer: 'SHA-256 is recommended for most applications. Use SHA-512 for higher security, or SHA3 for the latest standard. Avoid MD5 and SHA-1 for security-critical applications.' },
      ],
      usage: [
        'Select hash type (SHA-256, SHA-512, etc.).',
        'Enter HMAC key (ASCII or Hexadecimal).',
        'Enter data to authenticate.',
        'Click "Calculate HMAC".',
      ],
    },
    cmac: {
      title: 'CMAC Calculator Online - Cipher-based Message Authentication | HSM Kit',
      description: 'Free online CMAC calculator for AES and TDES. Generate cipher-based message authentication codes.',
      keywords: 'CMAC calculator, AES-CMAC, TDES-CMAC, cipher-based MAC, AES CMAC 96, message authentication',
      faqTitle: 'CMAC FAQ',
      usageTitle: 'How to Use CMAC Calculator',
      faqs: [
        { question: 'What is CMAC?', answer: 'CMAC (Cipher-based Message Authentication Code) is a block cipher-based MAC algorithm. It uses AES or TDES to generate authentication tags.' },
        { question: 'What is AES CMAC 96?', answer: 'AES CMAC 96 is a truncated version of AES-CMAC that outputs 96 bits (12 bytes) instead of 128 bits. It is used in some protocols where shorter MACs are acceptable.' },
      ],
      usage: [
        'Select encryption type (AES or TDES).',
        'Enter CMAC key with correct length.',
        'Enter data to authenticate.',
        'Optionally enable AES CMAC 96 for truncation.',
      ],
    },
    retailMac: {
      title: 'Retail MAC Calculator Online - DES & 3DES Message Authentication | HSM Kit',
      description: 'Free online Retail MAC calculator. Generate MACs using DES or 3DES with optional 3DES finalization.',
      keywords: 'Retail MAC, DES MAC, 3DES MAC, message authentication, payment MAC, financial MAC',
      faqTitle: 'Retail MAC FAQ',
      usageTitle: 'How to Use Retail MAC Calculator',
      faqs: [
        { question: 'What is Retail MAC?', answer: 'Retail MAC is a widely-used MAC algorithm in payment systems that uses DES or 3DES with ISO 9797-1 Method 2 padding. Optional 3DES finalization provides enhanced security.' },
        { question: 'Should I use 3DES finalization?', answer: 'Yes, 3DES finalization is recommended for better security. It encrypts the final MAC block with 3DES, making the MAC more resistant to attacks.' },
      ],
      usage: [
        'Select algorithm (DES or 3DES).',
        'Choose finalization method (None or 3DES).',
        'Enter keys and data.',
        'Click "Calculate MAC".',
      ],
    },
