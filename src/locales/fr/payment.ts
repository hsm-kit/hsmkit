...
export default {
  ...
  as2805: {
    ...
    outPinBlock: 'Bloc PIN sortant',
    // Labels des résultats
    resultKekFlag: 'Drapeau KEK',
    resultKekr: 'KEKr',
    resultSchemeKek: 'Schéma KEK',
    resultSchemeLmk: 'Schéma LMK',
    resultKcvType: 'Type KCV',
    resultZpkUnderLmk: 'ZPK sous LMK',
    resultZpkUnderKek: 'ZPK sous KEK',
    resultKcvZpk: 'KCV de ZPK',
    resultTpkUnderLmk: 'TPK sous LMK',
    resultTpkUnderKek: 'TPK sous KEK',
    resultKcvTpk: 'KCV de TPK',
    resultTaksUnderLmk: 'TAKs sous LMK',
    resultTakrUnderLmk: 'TAKr sous LMK',
    resultTaksUnderKek: 'TAKs sous KEK',
    resultTakrUnderKek: 'TAKr sous KEK',
    resultKcvTaks: 'KCV de TAKs',
    resultKcvTakr: 'KCV de TAKr',
    resultTeksUnderLmk: 'TEKs sous LMK',
    resultTekrUnderLmk: 'TEKr sous LMK',
    resultTeksUnderKek: 'TEKs sous KEK',
    resultTekrUnderKek: 'TEKr sous KEK',
    resultKcvTeks: 'KCV de TEKs',
    resultKcvTekr: 'KCV de TEKr',
  },
