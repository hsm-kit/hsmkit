...
export default {
  cipher: {
    ...
    // Erreurs du formulaire de chiffrement symétrique
    errorKeyHexRequired: 'La clé doit être un hexadécimal valide',
    errorKeyLengthSingle: 'La longueur de la clé doit être de {length} octets',
    errorKeyLengthMultiple: 'La longueur de la clé doit être de {lengths} octets',
    errorDataHexRequired: 'Les données doivent être un hexadécimal valide',
    errorDataBlockSize: 'La longueur des données doit être un multiple de {blockSize} octets (actuel : {current} octets)',
    errorIvHexRequired: 'L\'IV doit être un hexadécimal valide',
    errorIvBlockSize: 'La longueur de l\'IV doit être de {blockSize} octets',
  },
  ...
  rsa: {
    ...
    signingFinished: 'Opération de signature des données terminée',
    ...
    // Labels des détails du résultat
    privateKeyLabel: 'Exposant privé (d):',
    keyLengthLabel: 'Longueur de clé:',
    encryptionMethodLabel: 'Méthode de chiffrement:',
    decryptionMethodLabel: 'Méthode de déchiffrement:',
    paddingMethodLabel: 'Méthode de remplissage:',
    originalDataLabel: 'Données originales:',
    cipherDataLabel: 'Données chiffrées:',
    publicModulusLabel: 'Modulus public [n]:',
    publicExponentLabel: 'Exposant public [e]:',
    privateExponentLabel: 'Exposant privé [d]:',
    encodedDataLabel: 'Données encodées:',
    encodedDataLengthLabel: 'Longueur des données encodées:',
    decodedDataLabel: 'Données décodées:',
    decodedDataLengthLabel: 'Longueur des données décodées:',
    stringToSignLabel: 'Chaîne à signer:',
    stringToSignLengthLabel: 'Longueur de la chaîne à signer:',
    messageDigestTypeLabel: 'Type de résumé de message:',
    messageDigestLengthLabel: 'Longueur du résumé de message:',
    stringToHashLabel: 'Chaîne pour le hash {hash}:',
    messageSignatureLabel: 'Signature du message:',
    messageSignatureLengthLabel: 'Longueur de la signature du message:',
    // Onglet de vérification
    inputTypeLabel: 'Type d\'entrée:',
    inputDataWillBeHashed: 'Données (seront hachées)',
    inputHashDirectComparison: 'Hash (comparaison directe)',
    hashToVerify: 'Hash à vérifier',
    hashPlaceholder: 'Entrez la valeur hash en hexadécimal (ex: SHA-1: 40 caractères)',
    hashAlgorithmHint: 'Sélectionnez l\'algorithme utilisé lors de la signature pour extraire la longueur de hash correcte',
    // Onglet OAEP
    encodingParametersLabel: 'Paramètres d\'encodage:',
    optionalLabelPlaceholder: 'Label optionnel (vide par défaut)',
    methodLabel: 'Méthode:',
    resultLengthLabel: 'Longueur du résultat:',
    hashFunctionLabel: 'Fonction de hash:',
    encodedMessageLabel: '✓ Message encodé (EM):',
    decodedMessageLabel: '✓ Message décodé:',
    resultLengthBytes: 'Longueur: {bytes} octets ({bits} bits)',
    oaepStructureReference: '📖 Structure & Référence OAEP',
    structureLabel: 'Structure:',
    maxDataSizeLabel: 'Taille maximale des données (k = octets de clé):',
    oaepMaxSizeSHA1: 'SHA-1: k - 42 octets',
    oaepMaxSizeSHA224: 'SHA-224: k - 58 octets',
    oaepMaxSizeSHA256: 'SHA-256: k - 66 octets',
    oaepMaxSizeSHA384: 'SHA-384: k - 98 octets',
    oaepMaxSizeSHA512: 'SHA-512: k - 130 octets',
    oaepEncodePlaceholder: 'Entrez les données à encoder (hexadécimal)',
    oaepDecodePlaceholder: 'Entrez les données OAEP encodées (hexadécimal)',
    encode: 'Encoder',
    decode: 'Décoder',
    bits: 'bits',
  },
