...
export default {
  ...
  home: {
    ...
    features: {
      ...
      free: {
        ...
        description: 'Über 44 Tools völlig kostenlos. Keine Registrierung, kein Login, keine versteckten Kosten. Sofort nutzbar.',
      },
      paymentReady: {
  ...
  seo: {
    home: {
      ...
      faqs: [
        { question: 'Ist HSM Kit kostenlos?', answer: 'Ja, HSM Kit ist 100% kostenlos mit über 44 Kryptografie-Tools. Keine Registrierung, kein Login, keine Zahlung erforderlich. Alle Funktionen sofort verfügbar.' },
      ...
      usage: [
        '• HSM Kit ist eine umfassende Suite von über 44 Kryptografie-Tools für Sicherheitsexperten, Entwickler und alle, die mit Verschlüsselung und Zahlungssystemen arbeiten.',
    ...
    tdesCbcMac: {
      ...
      usage: [
        '• Schlüsseltyp auswählen: 3-Schlüssel-TDES (48 Hex, maximale Sicherheit) oder 2-Schlüssel-TDES (32 Hex, Legacy-Systeme).',
        '• TDES-Schlüssel in Hex-Format eingeben.',
        '• Padding-Methode wählen: Methode 1 (Null-Padding) oder Methode 2 (0x80 + Nullen, empfohlen).',
        '• Nachrichtendaten in Hex-Format eingeben.',
        '• Kürzungslänge (1-8 Bytes) festlegen und "MAC berechnen" klicken.',
      ],
    },
    hmac: {
      ...
      usage: [
        '• Hash-Algorithmus auswählen (SHA-256 für die meisten Anwendungen empfohlen, SHA-512 für hohe Sicherheit).',
        '• Schlüsselformat (Hex oder ASCII) wählen und geheimen Schlüssel eingeben.',
        '• Datenformat (Hex oder ASCII) wählen und zu authentifizierende Nachricht eingeben.',
        '• "HMAC berechnen" klicken, um den Authentifizierungscode zu generieren.',
        '• HMAC-Ergebnis für API-Header, Webhooks oder Verifizierungssysteme kopieren.',
      ],
    },
    cmac: {
      ...
      usage: [
        '• Verschlüsselungsalgorithmus auswählen: AES (empfohlen) oder TDES für Legacy-Systeme.',
        '• Schlüsselformat wählen und Schlüssel eingeben (AES: 32/48/64 Hex-Zeichen; TDES: 32/48 Hex-Zeichen).',
        '• Datenformat wählen und zu authentifizierende Nachricht eingeben.',
        '• Optional: "AES CMAC 96" aktivieren für 96-Bit-Ausgabe (üblich in IPsec/802.11i).',
        '• "CMAC berechnen" klicken und Ergebnis kopieren.',
      ],
    },
    retailMac: {
      ...
      usage: [
        '• Algorithmus auswählen: DES für Legacy-Systeme, 3DES für durchgehend erhöhte Sicherheit.',
        '• Finalisierung wählen: "Keine" für Standardverarbeitung, "3DES" für erhöhte Sicherheit des letzten Blocks.',
        '• Schlüssel K (16 Hex-Zeichen) eingeben. Bei 3DES-Finalisierung oder 3-Schlüssel-Modus auch K\' eingeben.',
        '• Nachrichtendaten in Hex eingeben. ISO 9797-1 Methode 2 Padding wird automatisch angewendet.',
        '• Kürzungslänge (1-8 Bytes) festlegen und "MAC berechnen" klicken.',
      ],
    },
    zka: {
    ...
    ansiMac: {
      ...
      usage: [
        '• MAC-Algorithmus auswählen: X9.9 (Wholesale) für DES CBC-MAC, X9.19 (Retail) für 3DES-Endblock.',
        '• Primären DES-Schlüssel K (16 Hex) eingeben. Bei X9.19 mit separaten Schlüsseln auch K\' (16 Hex) eingeben.',
        '• Daten in Hex-Format eingeben (automatisch auf 8-Byte-Blöcke aufgefüllt).',
        '• Kürzungslänge (1-8 Bytes) festlegen. Standard ist 4 Bytes für die meisten Anwendungen.',
        '• "Calculate MAC" klicken und Ergebnis kopieren.',
      ],
    },
    as2805Mac: {
      ...
      usage: [
        '• MAC-Methode auswählen: Methode 1 (DES CBC) oder Methode 2 (DES CBC + 3DES-Endblock).',
        '• Linken Schlüssel K|KL (16 Hex) und rechten Schlüssel KR (16 Hex) eingeben.',
        '• Transaktionsdaten in Hex-Format eingeben.',
        '• Kürzungslänge (1-8 Bytes, Standard-EFTPOS verwendet 4 Bytes) festlegen.',
        '• "MAC berechnen" klicken und Ergebnis für Zahlungsnachricht kopieren.',
      ],
    },
    iso9797Mac: {
