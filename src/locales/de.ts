...
export default {
  ...
  home: {
    ...
    tools: {
      ...
      dukpt: {
        ...
        description: 'PEK von BDK/IPEK und KSN ableiten. PIN verschlüsseln/entschlüsseln, MAC berechnen, Daten verarbeiten.',
      },
      dukptAes: {
        title: 'DUKPT (AES)',
  ...
  as2805: {
    ...
    info1: 'Enthält Terminal-Schlüsselsatz, PIN-Block-Übersetzung, MAC und OWF',
