...
export default {
  cipher: {
    ...
    // Symmetrische Chiffre Formularfehler
    errorKeyHexRequired: 'Schlüssel muss gültiges Hexadezimal sein',
    errorKeyLengthSingle: 'Schlüssellänge muss {length} Byte sein',
    errorKeyLengthMultiple: 'Schlüssellänge muss {lengths} Byte sein',
    errorDataHexRequired: 'Daten müssen gültiges Hexadezimal sein',
    errorDataBlockSize: 'Datenlänge muss ein Vielfaches von {blockSize} Byte sein (aktuell: {current} Byte)',
    errorIvHexRequired: 'IV muss gültiges Hexadezimal sein',
    errorIvBlockSize: 'IV-Länge muss {blockSize} Byte sein',
  },
  ...
  rsa: {
    ...
    signingFinished: 'Daten-Signierung abgeschlossen',
    ...
    // Ergebnis-Details Labels
    privateKeyLabel: 'Privater Exponent (d):',
    keyLengthLabel: 'Schlüssellänge:',
    encryptionMethodLabel: 'Verschlüsselungsmethode:',
    decryptionMethodLabel: 'Entschlüsselungsmethode:',
    paddingMethodLabel: 'Padding-Methode:',
    originalDataLabel: 'Originaldaten:',
    cipherDataLabel: 'Verschlüsselte Daten:',
    publicModulusLabel: 'Öffentlicher Modulus [n]:',
    publicExponentLabel: 'Öffentlicher Exponent [e]:',
    privateExponentLabel: 'Privater Exponent [d]:',
    encodedDataLabel: 'Kodierte Daten:',
    encodedDataLengthLabel: 'Kodierte Datenlänge:',
    decodedDataLabel: 'Dekodierte Daten:',
    decodedDataLengthLabel: 'Dekodierte Datenlänge:',
    stringToSignLabel: 'Zu signierende Zeichenkette:',
    stringToSignLengthLabel: 'Länge der zu signierenden Zeichenkette:',
    messageDigestTypeLabel: 'Nachrichten-Digest Typ:',
    messageDigestLengthLabel: 'Nachrichten-Digest Länge:',
    stringToHashLabel: 'Zeichenkette für {hash} Hash:',
    messageSignatureLabel: 'Nachrichtensignatur:',
    messageSignatureLengthLabel: 'Nachrichtensignatur Länge:',
    // Verifizierung Tab
    inputTypeLabel: 'Eingabetyp:',
    inputDataWillBeHashed: 'Daten (werden gehasht)',
    inputHashDirectComparison: 'Hash (direkter Vergleich)',
    hashToVerify: 'Zu verifizierender Hash',
    hashPlaceholder: 'Hexadezimalen Hashwert eingeben (z.B. SHA-1: 40 Zeichen)',
    hashAlgorithmHint: 'Wählen Sie den beim Signieren verwendeten Algorithmus, um die richtige Hash-Länge zu extrahieren',
    // OAEP Tab
    encodingParametersLabel: 'Kodierungsparameter:',
    optionalLabelPlaceholder: 'Optionales Label (Standard: leer)',
    methodLabel: 'Methode:',
    resultLengthLabel: 'Ergebnislänge:',
    hashFunctionLabel: 'Hash-Funktion:',
    encodedMessageLabel: '✓ Kodierte Nachricht (EM):',
    decodedMessageLabel: '✓ Dekodierte Nachricht:',
    resultLengthBytes: 'Länge: {bytes} Bytes ({bits} Bits)',
    oaepStructureReference: '📖 OAEP Struktur & Referenz',
    structureLabel: 'Struktur:',
    maxDataSizeLabel: 'Maximale Datengröße (k = Schlüssel-Bytes):',
    ...
    oaepEncodePlaceholder: 'Zu kodierende Daten eingeben (hexadezimal)',
    oaepDecodePlaceholder: 'OAEP-kodierte Daten eingeben (hexadezimal)',
    encode: 'Kodieren',
    decode: 'Dekodieren',
    bits: 'Bits',
  },
