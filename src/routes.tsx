...
export const SSLCertificatesPage = lazy(
  () => import("./pages/pki/SSLCertificatesPage"),
);
...
// Key Management
export const KeyGeneratorPage = lazy(
  () => import("./pages/keys/KeyGeneratorPage"),
);
export const TR31Page = lazy(() => import("./pages/keys/TR31Page"));
export const KeysharePage = lazy(() => import("./pages/keys/KeysharePage"));
export const FuturexKeysPage = lazy(
  () => import("./pages/keys/FuturexKeysPage"),
);
export const AtallaKeysPage = lazy(() => import("./pages/keys/AtallaKeysPage"));
export const SafeNetKeysPage = lazy(
  () => import("./pages/keys/SafeNetKeysPage"),
);
export const ThalesKeysPage = lazy(() => import("./pages/keys/ThalesKeysPage"));
export const ThalesKeyBlockPage = lazy(
  () => import("./pages/keys/ThalesKeyBlockPage"),
);
...
export const MastercardCVC3Page = lazy(
  () => import("./pages/payment/MastercardCVC3Page"),
);
...
export const AS2805MACPage = lazy(
  () => import("./pages/payment/AS2805MACPage"),
);
export const TDESCBCMACPage = lazy(
  () => import("./pages/payment/TDESCBCMACPage"),
);
export const HMACPage = lazy(() => import("./pages/payment/HMACPage"));
export const CMACPage = lazy(() => import("./pages/payment/CMACPage"));
export const RetailMACPage = lazy(
  () => import("./pages/payment/RetailMACPage"),
);

// PIN Block Tools
export const PinBlockGeneralPage = lazy(
  () => import("./pages/payment/PinBlockGeneralPage"),
);
export const PinBlockAESPage = lazy(
  () => import("./pages/payment/PinBlockAESPage"),
);
export const PinOffsetPage = lazy(
  () => import("./pages/payment/PinOffsetPage"),
);
export const PinPVVPage = lazy(() => import("./pages/payment/PinPVVPage"));

// VISA Tools
export const VISACertificatesPage = lazy(
  () => import("./pages/payment/VISACertificatesPage"),
);
...
export const CharacterEncodingPage = lazy(
  () => import("./pages/generic/CharacterEncodingPage"),
);
export const BCDPage = lazy(() => import("./pages/generic/BCDPage"));
export const CheckDigitsPage = lazy(
  () => import("./pages/generic/CheckDigitsPage"),
);
export const Base64Page = lazy(() => import("./pages/generic/Base64Page"));
export const Base94Page = lazy(() => import("./pages/generic/Base94Page"));
export const MessageParserPage = lazy(
  () => import("./pages/generic/MessageParserPage"),
);
export const RSADerPublicKeyPage = lazy(
  () => import("./pages/generic/RSADerPublicKeyPage"),
);
export const UUIDPage = lazy(() => import("./pages/generic/UUIDPage"));

// Legal Pages
// Guide routes are owned by the standalone GuidesApp entry.
